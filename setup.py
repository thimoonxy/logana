...
setup(
    ...
    description='Varnish logs analysis CLI',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/thimoonxy/logana',
    download_url = 'https://github.com/thimoonxy/logana/tarball/1.0.0',
    # Author details
    author='Simon Xie',
